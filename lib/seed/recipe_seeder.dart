    ...
    final templates = <_RecipeTemplate>[
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Season and slice the chicken into bite-size strips.',
            timerSeconds: 180,
          ),
          RecipeStepDraft(
            instruction: 'Saute onion and garlic in oil until fragrant.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction:
                'Cook chicken until lightly browned, then add soy sauce.',
            timerSeconds: 420,
          ),
          RecipeStepDraft(
            instruction: 'Serve over cooked rice and finish with black pepper.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Press tofu and cut into cubes.',
            timerSeconds: 300,
          ),
          RecipeStepDraft(
            instruction: 'Stir-fry tofu until golden and set aside.',
            timerSeconds: 300,
          ),
          RecipeStepDraft(
            instruction:
                'Cook vegetables with garlic, then add tofu and soy sauce.',
            timerSeconds: 420,
          ),
          RecipeStepDraft(
            instruction: 'Serve over warm brown rice.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          ...
          RecipeStepDraft(
            instruction:
                'Saute onion and garlic, then add tomatoes until softened.',
            timerSeconds: 360,
          ),
          RecipeStepDraft(
            instruction:
                'Add tuna, toss in spaghetti, and loosen with pasta water.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
      ...
      _RecipeTemplate(
        ...
        description:
            'Comforting lentil soup packed with vegetables and flavor.',
        servings: 4,
        prepTime: 20,
        cookTime: 35,
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Saute onion, carrot, and garlic until aromatic.',
            timerSeconds: 360,
          ),
          RecipeStepDraft(
            instruction: 'Add lentils, tomatoes, and water.',
            timerSeconds: 120,
          ),
          RecipeStepDraft(
            instruction: 'Simmer until lentils are tender.',
            timerSeconds: 1500,
          ),
          RecipeStepDraft(
            instruction: 'Stir in kale, season, and cook briefly.',
            timerSeconds: 180,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        description:
            'Savory fried rice with shrimp, egg, and crunchy vegetables.',
        servings: 3,
        prepTime: 14,
        cookTime: 15,
        ...
        steps: <RecipeStepDraft>[
          ...
          RecipeStepDraft(
            instruction: 'Stir-fry shrimp until pink, then remove.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction: 'Cook carrot and rice, then add soy sauce.',
            timerSeconds: 360,
          ),
          RecipeStepDraft(
            instruction: 'Return shrimp and egg, toss with scallions.',
            timerSeconds: 180,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        description:
            'Tender beef and broccoli in a quick soy-garlic pan sauce.',
        servings: 2,
        prepTime: 16,
        cookTime: 14,
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Sear beef strips in a hot pan and remove.',
            timerSeconds: 300,
          ),
          RecipeStepDraft(
            instruction: 'Cook broccoli until bright and crisp-tender.',
            timerSeconds: 300,
          ),
          RecipeStepDraft(
            instruction: 'Add garlic, soy sauce, and return beef.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction: 'Finish with black pepper and serve.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Cook quinoa until fluffy.',
            timerSeconds: 900,
          ),
          RecipeStepDraft(
            instruction: 'Season salmon and sear until just cooked.',
            timerSeconds: 420,
          ),
          RecipeStepDraft(
            instruction: 'Saute spinach quickly in olive oil.',
            timerSeconds: 120,
          ),
          RecipeStepDraft(
            instruction: 'Plate with lemon juice over salmon.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        description:
            'Fresh, creamy, and protein-rich salad with lemon dressing.',
        servings: 2,
        prepTime: 12,
        cookTime: 0,
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Rinse chickpeas and drain well.',
            timerSeconds: 120,
          ),
          RecipeStepDraft(
            instruction: 'Dice avocado, cucumber, and tomato.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction: 'Toss all ingredients with lemon juice and olive oil.',
            timerSeconds: 120,
          ),
          RecipeStepDraft(
            instruction: 'Season to taste and serve chilled.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          ...
          RecipeStepDraft(
            instruction: 'Saute onion, tomato, and spinach briefly.',
            timerSeconds: 150,
          ),
          RecipeStepDraft(
            instruction: 'Pour eggs and cook until set.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction: 'Fold and serve warm.',
            timerSeconds: 60,
          ),
        ],
      ),
      _RecipeTemplate(
        ...
        steps: <RecipeStepDraft>[
          RecipeStepDraft(
            instruction: 'Brown pork with garlic and onion.',
            timerSeconds: 420,
          ),
          RecipeStepDraft(
            instruction: 'Add tomato and cook until softened.',
            timerSeconds: 240,
          ),
          RecipeStepDraft(
            instruction: 'Add potato, carrot, water, and simmer.',
            timerSeconds: 1800,
          ),
          RecipeStepDraft(
            instruction: 'Season and cook until pork is tender.',
            timerSeconds: 480,
          ),
        ],
      ),
