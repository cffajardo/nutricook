...
class DatabaseSeeder {
  ...
  static Future<void> _seedTechniques() async {
    final techniques = [
      ...
      const Technique(id: 'blend', name: 'Blend', category: TechniqueCategory.preparation, description: 'Combine ingredients until smooth'),
      const Technique(id: 'whisk', name: 'Whisk', category: TechniqueCategory.preparation, description: 'Beat vigorously to incorporate air'),
      const Technique(id: 'fold', name: 'Fold', category: TechniqueCategory.preparation, description: 'Gently combine ingredients without deflating'),
      const Technique(id: 'knead', name: 'Knead', category: TechniqueCategory.preparation, description: 'Work dough to develop gluten'),
