...
mixin _$Recipe {
 ...
 String get id; String get name; List<RecipeIngredient> get ingredients; List<RecipeStep> get steps; String get description; bool get isPublic; int get servings; int get cookTime; int get prepTime;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get updatedAt; NutritionInfo? get nutritionTotal; NutritionInfo? get nutritionPerServing; String? get ownerId; int get favoriteCount; int get reportCount; List<String> get favoritedBy; List<String> get tags; List<String> get techniqueIDs; List<String> get imageURL;
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<RecipeIngredient> ingredients,  List<RecipeStep> steps,  String description,  bool isPublic,  int servings,  int cookTime,  int prepTime, @TimestampConverter()  DateTime createdAt, @TimestampConverter()  DateTime updatedAt,  NutritionInfo? nutritionTotal,  NutritionInfo? nutritionPerServing,  String? ownerId,  int favoriteCount,  int reportCount,  List<String> favoritedBy,  List<String> tags,  List<String> techniqueIDs,  List<String> imageURL)  $default,) {final _that = this;
switch (_that) {
case _Recipe():
return $default(_that.id,_that.name,_that.ingredients,_that.steps,_that.description,_that.isPublic,_that.servings,_that.cookTime,_that.prepTime,_that.createdAt,_that.updatedAt,_that.nutritionTotal,_that.nutritionPerServing,_that.ownerId,_that.favoriteCount,_that.reportCount,_that.favoritedBy,_that.tags,_that.techniqueIDs,_that.imageURL);case _:
  throw StateError('Unexpected subclass');
